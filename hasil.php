							...
							<!-- <img src='assets/img/dokter.png' width='50%' style='float: right; margin-top: -30px;'> -->
								...
								if(isset($_POST['gejala'])){
									if(count($_POST['gejala'])<2){
										...
										$result = mysqli_query($koneksi,$queries);
										...
										$input = mysqli_query($koneksi,"INSERT INTO diagnosa (tanggal, gejala, penyakit, nilai, persentase) values('$tanggal', '$gejala', '$penyakit', '$nilai', '$persentase')");
