...
class BasisP
{
	...
	function TampilSemua()
	{
		...
		$query = mysqli_query($koneksi, "SELECT a.*, g.nama as nama_gejala,p.nama as nama_penyakit from ds_aturan a,ds_gejala g, ds_penyakit p where a.id_penyakit=p.id and a.id_gejala = g.id");
