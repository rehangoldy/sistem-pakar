...
class Riwayat
{
	...
	function TampilSemua()
	{
		...
		$query = mysqli_query($koneksi, "SELECT * from diagnosa");
		$i = 0;
	...
	{
		include "../koneksi/koneksi.php";
		$query = mysqli_query($koneksi, "DELETE FROM diagnosa WHERE id_diagnosa = '$id_diagnosa'");
	}

	function Count(){
		include 'koneksi/koneksi.php';
		$query = mysqli_query($koneksi, "SELECT COUNT(*) as jum FROM diagnosa");
